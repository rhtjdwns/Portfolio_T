...
namespace Unity.Services.Multiplay.Editor.MigrationPath
{
    static class Validator
    {
        const string k_ThisPackageIdentifier =
        ...
        const string k_FullyQualifiedRelayHandler =
            "Unity.Services.Relay.Editor.MigrationPath.Validator.OnRegisteredPackages";

        const string k_MigrationDocumentationURL =
            "https://docs.unity.com/ugs/en-us/manual/mps-sdk/manual/migration-path";

        const string k_UnityMultiplayerServices =
        ...
        static readonly string[] k_FullyQualifiedHandlers =
        {
            ...
            k_FullyQualifiedRelayHandler,
            k_ThisPackageFullyQualifiedHandler
        };
        //@formatter:on

        [InitializeOnLoadMethod]
        static void SubscribeToPackageManagerEvents()
        {
        ...
        static string WarningMessageWithDependency(
        ...
        static void OnRegisteredPackages(
